from chatterFlux.files.upload import parsefile
from chatterFlux.dataframe.dataframe import dataframe
from chatterFlux.dataframe.preprocessing import preprocess
from chatterFlux.api import insights
from chatterFlux.dummy.dummyapi import dummyapi
from chatterFlux.error.error import error
# from chatterFlux.firebase.firebase import db
...
def hello():
    return 'What ya doing here???  <a href="http://github.com/Phiyan18">Head over to</a>'
